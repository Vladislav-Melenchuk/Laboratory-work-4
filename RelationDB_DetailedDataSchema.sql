...
ALTER TABLE USER_T MODIFY (NAME NOT NULL);
...
ALTER TABLE SYSTEM_T MODIFY (VERSION NOT NULL);
...
ALTER TABLE RECOMMENDATION
    ADD CONSTRAINT FK_REC_SYSTEM
    FOREIGN KEY (SYSTEM_ID)
    REFERENCES SYSTEM_T (SYSTEM_ID);
...
ALTER TABLE NOTIFICATION
    ADD CONSTRAINT FK_NOTIF_SYSTEM
    FOREIGN KEY (SYSTEM_ID)
    REFERENCES SYSTEM_T (SYSTEM_ID);
...
ALTER TABLE THREAT
    ADD CONSTRAINT PK_THREAT
    PRIMARY KEY (THREAT_ID);

ALTER TABLE THREAT MODIFY (SYSTEM_ID NOT NULL);

ALTER TABLE THREAT
    ADD CONSTRAINT FK_THREAT_SYSTEM
    FOREIGN KEY (SYSTEM_ID)
    REFERENCES SYSTEM_T (SYSTEM_ID);

ALTER TABLE THREAT
    ADD CONSTRAINT CHK_THREAT_RISK
...
ALTER TABLE IDENTIFICATION
    ADD CONSTRAINT PK_IDENTIFICATION
    PRIMARY KEY (IDENTIFICATION_ID);

ALTER TABLE IDENTIFICATION MODIFY (IDENTIFIER NOT NULL);

ALTER TABLE IDENTIFICATION
    ADD CONSTRAINT UQ_IDENT_USER
    UNIQUE (USER_ID);

ALTER TABLE IDENTIFICATION
    ADD CONSTRAINT FK_IDENT_USER
    FOREIGN KEY (USER_ID)
    REFERENCES USER_T (USER_ID);

ALTER TABLE IDENTIFICATION
    ADD CONSTRAINT CHK_IDENTIFIER_FORMAT
