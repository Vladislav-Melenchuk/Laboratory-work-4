...
ALTER TABLE THREAT_T ADD CONSTRAINT PK_THREAT
PRIMARY KEY (THREAT_ID);
ALTER TABLE THREAT_T MODIFY (SYSTEM_ID NOT NULL);
ALTER TABLE THREAT_T ADD CONSTRAINT FK_THREAT_SYSTEM
FOREIGN KEY (SYSTEM_ID) REFERENCES SYSTEM_T (SYSTEM_ID);
ALTER TABLE THREAT_T ADD CONSTRAINT CHK_THREAT_RISK
